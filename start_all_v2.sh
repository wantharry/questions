#!/bin/bash
# Start all services - Backend + Enhanced Frontend (Multi-Index UI)
# Usage: ./start_all_v2.sh

echo "=========================================="
echo "  Starting RAG System (Multi-Index UI)"
echo "=========================================="
echo ""
...
echo ""
echo "[4/4] Starting Enhanced Frontend (Multi-Index UI) on port $FRONTEND_PORT..."
cd "$PROJECT_DIR/frontend" || exit 1

nohup streamlit run streamlit_app_v2.py --server.port $FRONTEND_PORT --server.address 0.0.0.0 > /tmp/rag_frontend_v2.log 2>&1 &
FRONTEND_PID=$!
disown
...
echo ""
echo "=========================================="
echo "  RAG System Started (Multi-Index UI)"
echo "=========================================="
echo ""
echo "Backend:  http://localhost:$BACKEND_PORT"
echo "Frontend: http://localhost:$FRONTEND_PORT (Multi-Index UI)"
...
echo "  Frontend: tail -f /tmp/rag_frontend_v2.log"
echo ""
